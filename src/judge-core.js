...
function parseSubmission(text, maximumQuestionNumber) {
...
function gradeSubmission(text, questions) {
...
globalThis.CalculusJudge = { STATUS, normalizeToken, parseSubmission, gradeSubmission };
